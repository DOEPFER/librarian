...
config_subparser.add_argument('-p', '--prefix', help='Log file prefix.', type=str, default='librarian')
config_subparser.add_argument('-v', '--verbose', help='Verbose mode.', action='store_true')
